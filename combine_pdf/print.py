...
button = Button(mainframe, text=u"\uD83D\uDCC1" ' BROWSE',
...
dec_button = Button(button_frame, text=u"\u2212", command=copies_decrease,
                    fg="dark green", bg="white", height=1, width=3)
dec_button['font'] = font_size(10)

inc_button = Button(button_frame, text=u"\uFF0B", command=copies_increase,
                    fg="dark green", bg="white", height=1, width=3)
...
p_button = Button(mainframe, text=u'\uD83D\uDDB6' + " PRINT",
                  command=PrintAction, fg="dark green", bg="white")
